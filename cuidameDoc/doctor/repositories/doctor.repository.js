...
exports.updateDoctor = async (id, first_name, last_name, identification_type, identification_number, city_id, address, phone, medical_record, medical_specialist, landline_phone, note, rating) => {
  const query = 'UPDATE doctors SET first_name = $1, last_name = $2, identification_type = $3, identification_number = $4, city_id = $5, address = $6, phone = $7, medical_record = $8, medical_specialist = $9, landline_phone = $10, note = $11, rating = $12 WHERE id = $13 RETURNING *';
