...
exports.createContract = async (health_insurance_id, type, start_date, end_date) => {
  const query = 'INSERT INTO contracts (health_insurance_id, type, start_date, end_date) VALUES ($1, $2, $3, $4) RETURNING *';
...
exports.updateContract = async (id, health_insurance_id, type, start_date, end_date) => {
  const query = 'UPDATE contracts SET health_insurance_id = $1, type = $2, start_date = $3, end_date = $4 WHERE id = $5 RETURNING *';
