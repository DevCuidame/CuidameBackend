INSERT INTO
    townships (id, department_id, code, name)
VALUES
    (1, 1, 1, 'MEDELLIN'),
    (2, 1, 2, 'ABEJORRAL'),
    (3, 1, 4, 'ABRIAQUI'),
    ...
    (
        ...
        4,
        1,
        'CARTAGENA (DISTRITO TURISTICO Y CULTURAL DE CARTAGENA)'
    ),
    (171, 4, 6, 'ACHI'),
    ...
    (
        ...
        12,
        250,
        'LITORAL DEL BAJO SAN JUAN (SANTA GENOVEVA DE DOCORDO)'
    ),
    (602, 12, 361, 'ISTMINA'),
    (603, 12, 372, 'JURADO'),
    (604, 12, 413, 'LLORO'),
    ...
    (
        ...
        15,
        1,
        'SANTA MARTA (DISTRITO TURISTICO CULTURAL E HISTORICO DE SANTA MARTA)'
    ),
    (668, 15, 30, 'ALGARROBO'),
    (669, 15, 53, 'ARACATACA'),
